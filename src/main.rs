...
//!
//! Birkac hazir sekli (elips, cember, sekiz, kalp, yildiz) DAC dual mode +
//! TIM6 tetigi + DMA ile ureti. Osiloskobu XY moduna al: PA4 = yatay,
//! PA5 = dikey.
//!
...
# shape: ellipse | circle | figure8 | heart | star
shape     = heart
amplitude = 0.85
offset    = 0.5
frame_hz  = 60
